...
if (len(LpImg)):
    ...
    binary2 = cv2.threshold(gray2, 127, 255,
                           cv2.THRESH_BINARY | cv2.THRESH_OTSU)[1]
    ...
    text2 = pytesseract.image_to_string(binary2, lang="eng", config="--psm 7")

    # Viet bien so len anh
    cv2.putText(Ivehicle, fine_tune(text+text2), (50, 50), cv2.FONT_HERSHEY_PLAIN, 3.0, (0, 0, 255), lineType=cv2.LINE_AA)
